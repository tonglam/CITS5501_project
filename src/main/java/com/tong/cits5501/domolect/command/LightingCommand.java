...
public final class LightingCommand extends Command {
  ...
  /**
   * Constructs a java.com.tong.cits5501.command.LightingCommand with the specified location, light source,
   * and desired state.
   *
   ...
   * appropriate java.com.tong.cits5501.command.LightSource.
   */
  @Override
  public void execute() {
    switch (getState()) {
