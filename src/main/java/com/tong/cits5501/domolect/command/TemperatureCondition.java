...
public final class TemperatureCondition extends Condition {
  ...
  /**
   * Constructs a java.com.tong.cits5501.command.TemperatureCondition with the specified temperature in Kelvin
  ...
  /**
   * Returns a string representation of the java.com.tong.cits5501.command.TemperatureCondition.
   * 
   * @return a string describing the condition with its temperature in Kelvin
   */
  @Override
  public String toString() {
    return "java.com.tong.cits5501.command.TemperatureCondition at " + kelvin + "K, comparison: " + comparison;
  }

  /**
   * Compares this java.com.tong.cits5501.command.TemperatureCondition to another object for equality.
   * 
   * @param o the object to compare to
   * @return true if the other object is a java.com.tong.cits5501.command.TemperatureCondition
  ...
  /**
   * Returns a hash code value for this java.com.tong.cits5501.command.TemperatureCondition.
   * 
