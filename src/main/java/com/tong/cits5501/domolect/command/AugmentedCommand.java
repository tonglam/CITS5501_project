...
public final class AugmentedCommand implements Executable {
  ...
  /**
   * Constructs an java.com.tong.cits5501.command.AugmentedCommand with the specified conditions and command.
   * 
  ...
  /**
   * Returns a string representation of the java.com.tong.cits5501.command.AugmentedCommand.
   * 
   * @return a string describing the augmented command, including its conditions and command
   */
  @Override
  public String toString() {
    return "java.com.tong.cits5501.command.AugmentedCommand [whenCondition=" + whenCondition +
           ", untilCondition=" + untilCondition + 
           ", command=" + command + "]";
  }

  /**
   * Compares this java.com.tong.cits5501.command.AugmentedCommand to another object for equality.
   * 
   * @param o the object to compare to
   * @return true if the other object is an java.com.tong.cits5501.command.AugmentedCommand with the same conditions and command, false otherwise
   */
  @Override
  ...
  /**
   * Returns a hash code value for this java.com.tong.cits5501.command.AugmentedCommand.
   * 
